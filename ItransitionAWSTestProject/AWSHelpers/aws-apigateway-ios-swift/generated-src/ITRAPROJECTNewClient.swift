...
public class ITRAPROJECTNewClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "ITRAPROJECTNewClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:ITRAPROJECTNewClient = {
        ...
        return ITRAPROJECTNewClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = ITRAPROJECTNewClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `ITRAPROJECTNewClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> ITRAPROJECTNewClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         ITRAPROJECTNewClient.registerClient(withConfiguration: configuration, forKey: "USWest2ITRAPROJECTNewClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = ITRAPROJECTNewClient.client(forKey: "USWest2ITRAPROJECTNewClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(ITRAPROJECTNewClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> ITRAPROJECTNewClient {
		objc_sync_enter(self)
		if let client: ITRAPROJECTNewClient = _serviceClients.object(forKey: key) as? ITRAPROJECTNewClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			ITRAPROJECTNewClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! ITRAPROJECTNewClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://r7tg6302e7.execute-api.us-east-1.amazonaws.com/test"
